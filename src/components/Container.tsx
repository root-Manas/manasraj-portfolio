...
const navLinks = [
  ...
  { href: "https://drive.google.com/file/d/1zLlOrTuxpTGc0mwDn8eL8PJZVf2mLFYw/view?usp=sharing", text: "Resume" },
];
...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Manasraj Singh",
    description: `Hacker, Engineer and Designer.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:site" content="wthmanas" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">Manasraj Singh</span>
        </Link>
